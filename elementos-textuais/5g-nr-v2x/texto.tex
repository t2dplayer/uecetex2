...
\section{Arquitetura e Modelagem \gls{5G} \gls{V2I} e \gls{C-V2X}}
...
\subsection{Interface Aérea \gls{5G} \gls{NR}: \gls{OFDMA} e Adaptação de Enlace}
...
\subsection{Comunicação Veicular \gls{C-V2X} e Interface \textit{Sidelink} \gls{PC5}}
