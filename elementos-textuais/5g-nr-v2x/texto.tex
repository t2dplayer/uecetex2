...
\end{tikzpicture}
\Caption{\label{fig:arquitetura_5g_macro} Modelo de sistema básico 3GPP evidenciando os dois grandes blocos operacionais do \gls{5G}.}
...
\subsection{Comunicação Veicular C-V2X e Interface \textit{Sidelink} PC5}
...
\fill[green!8, rounded corners=3pt] (2.65, -1.05) rectangle (4.45, -1.65);
\draw[green!55!black, thick, rounded corners=3pt] (2.65, -1.05) rectangle (4.45, -1.65);
\fill[cyan!18] (2.8, -1.57) rectangle (3.5, -1.18);
\draw[cyan!45, thin] (2.8, -1.57) rectangle (3.5, -1.18);
\fill[cyan!18] (3.6, -1.57) rectangle (4.3, -1.18);
\draw[cyan!45, thin] (3.6, -1.57) rectangle (4.3, -1.18);
...
\draw[green!55!black, thick] (3.55, -1.65) -- (3.55, -2.05);
\fill[green!55!black] (3.55, -2.05) circle (0.06);
\node (v2_ant) at (3.55, -2.05) {};
...
Para viabilizar essa comunicação direta, a camada física da \gls{PC5} organiza a troca de dados em três canais físicos complementares que operam sequencialmente dentro de um mesmo \textit{slot} de transmissão: o \textbf{\gls{PSCCH}} (\textit{Physical Sidelink Control Channel}), o \textbf{\gls{PSSCH}} (\textit{Physical Sidelink Shared Channel}), que transporta efetivamente a carga útil de dados, e o \textbf{\gls{PSFCH}} (\textit{Physical Sidelink Feedback Channel}). A Figura~\ref{fig:slot_sidelink} ilustra a coexistência e a multiplexação temporal desses canais dentro de um \textit{slot} do \gls{5G} \gls{NR} \textit{Sidelink}.
