...
Espera-se que o modelo híbrido \textit{\textit{Fuzzy}}-\gls{DRL} apresente uma convergência de aprendizado mais rápida e estável em comparação com um agente \gls{DRL} puro. Projeta-se que o modelo proposto reduza o tempo médio de resposta (latência fim-a-fim) e o consumo energético em comparação com métodos puramente heurísticos, demonstrando a viabilidade de integrar aprendizado por reforço e inferência \textit{\textit{fuzzy}} para tomadas de decisão eficientes em ambientes veiculares de alta mobilidade.
