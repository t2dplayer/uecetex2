...
As atividades de pesquisa restantes estão estruturadas para garantir a conclusão do modelo \textit{\textit{Fuzzy}}-\gls{DRL} e a validação experimental. A Tabela~\ref{tab:cronograma} apresenta o cronograma para o período de 2026 a 2027, culminando na defesa da tese.
