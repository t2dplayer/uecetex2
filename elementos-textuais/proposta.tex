...
O treinamento de cada política \gls{DRL} é conduzido em modo \textbf{\textit{offline}}, interagindo exclusivamente com o simulador, sem nenhum acesso ao ambiente real. O protocolo é o seguinte:
...
\subsection{Justificativa do Algoritmo \gls{SAC}}
