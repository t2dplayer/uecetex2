...
\begin{forest}
  ...
  [Descarregamento\\Computacional Veicular
    [Padrão de\\Comunicação
      ...
      [Servidor
        [{$\triangleright$ \gls{MEC}\\$\triangleright$ \gls{VEC}\\$\triangleright$ Nuvem}]
      ]
    ]
    [Problema
      [Estratégia
...
\subsection*{\textbf{\texorpdfstring{\gls{MEC}}{\gls{MEC}}}}
...
\subsection*{\textbf{\texorpdfstring{\gls{VEC}}{\gls{VEC}}}}
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|c|}
        \hline
        \multirow{2}{*}{Referência} & \multicolumn{2}{c|}{Tecnologia} & \multicolumn{3}{c|}{Servidor} & Observabilidade Parcial & \multirow{2}{*}{Canal Perfeito} & Carga de Trabalho \\ 
                                             & \gls{V2I} & \textbf{\textit{Sidelink} (\gls{V2V})} & \textbf{\gls{MEC}} & \textbf{\gls{VEC}} & Nuvem & (Incerteza de Estado) & & (Diferentes regimes) \\ \hline
