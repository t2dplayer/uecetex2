...
\begin{figure}[ht!]
\centering
\Caption{\label{fig:v2x-overview} Abstração do Ecossistema IoV: \gls{V2V}, \gls{V2I}, \gls{V2N} e \gls{V2P} em Cruzamento}
\vspace{0.2cm}
\begin{tikzpicture}[
    font=\sffamily,
    car top up/.pic={
...
\begin{table}[ht!]
    \centering
    \Caption{\label{tab:radio-tech-comparison} Comparativo técnico da evolução \gls{V2X}: do DSRC ao 6G}
    \UECEtab{}{
