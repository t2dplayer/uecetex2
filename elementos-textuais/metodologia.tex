...
1. Entidades (unidade processadora, tarefa)
    1.1 Unidade Processadora (OBU e \gls{VEC})
    ...
    1.5 Protocolo de Descoberta de Vizinhança, na camada de aplicação
        1.5.1 Emissão de Beacons Periódicos (via 5G NR e \gls{V2X} Sidelink)
            1.5.1.1 Conteúdo do Beacon (Device Specs, Estado Atual, velocidade, posição GPS, é \gls{VEC}?, é OBU?, etc)
...
2. Canal de comunicação
    ...
    2.2 Modelo de Canal \gls{V2X} Sidelink (PC5)
...
3. Descarregamento de tarefas
    3.1 Modos de Execução
        ...
        3.1.2 Descarregamento \gls{V2I} (para \gls{RSU} via 5G NR)
