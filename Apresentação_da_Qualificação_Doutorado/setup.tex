\usepackage{siunitx,booktabs,xcolor,colortbl,xspace,multirow,graphicx,lipsum}
...
\author[\textbf{Antônio Sérgio de Sousa Vieira}]{\textbf{Antônio Sérgio de Sousa Vieira \break sergio.vieira@ifce.edu.br \break sergio.vieira@aluno.uece.br}}
\date{}

\renewcommand{\maketitle}{
\begin{center}
    \includegraphics[height=1.0cm]{figuras/ifce.pdf}\hspace{0.5cm}
    \includegraphics[height=1.0cm]{figuras/uece_inetsys_desc_logo.png}
    \\[0.1cm]
...
\begin{center}
    ...
    \scriptsize
    \begin{tabular}{rl}
        \textbf{Orientador:} & Prof. Dr. Joaquim Celestino Júnior (UECE) \\
