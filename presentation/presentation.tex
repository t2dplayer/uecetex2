...
% ── Metadados ────────────────────────────────────────────────────────────────
\title[\textbf{SAC-TOPSIS para Redes Veiculares}]{%
...
\vspace{0.35cm}
\hspace{0.3cm}{\Large\bfseries\ttfamily PRIMEIRO PASSO DA PROPOSTA: PIPELINE SAC-TOPSIS}
...
% 26e. ALGORITMO 2: SAC-TOPSIS (INFERÊNCIA)
{
\setbeamercolor{background canvas}{bg=white}
\begin{frame}[plain, t]
\color{black}
...
\vspace{0.15cm}
\hspace{0.3cm}{\large\bfseries\ttfamily ALGORITMO 2 — SAC-TOPSIS (INFERÊNCIA)}
...
\textbf{SAC-TOPSIS} & \textbf{45,29} & \textbf{6,6} & 2582 & $\mathbf{+40,7}$ \\
\hline
\end{tabular}}
...
\begin{tikzpicture}[>=Stealth]
  ...
  \node[draw=black, line width=0.8pt, fill=black!04, rounded corners=4pt,
    ...
    PORÉM NÃO ALCANÇA SAC-TOPSIS (45,29\%): A REGRA ESTÁTICA IGNORA\\
  ...
  \node[draw=black, line width=1.4pt, fill=black!10, rounded corners=4pt,
    ...
    {\scriptsize\ttfamily
    JCT MÉDIO SAC-TOPSIS: \textbf{6,6 s} $\times$ SAC-BASE: \textbf{57,1 s}.\\
...
%   \node[font=\scriptsize\ttfamily, anchor=west] at (0.90,-3.85) {SAC-TOPSIS 0,2454};
...
% \begin{minipage}{0.92\textwidth}
% {\scriptsize\ttfamily\setlength{\baselineskip}{1.5\baselineskip}
% EXPERIMENTO CONTROLADO: PPO COM ESTADO 6D, AÇÃO BINÁRIA E MESMA RECOMPENSA DO SAC-TOPSIS.
